    ...
    <div class="content">
        ...
        <div class="container mt-4">
            ...
            <div class="btn-custom-container">
                <a href="ControladorHabitacionesVista?accion=listar" class="btn-custom habitaciones">VER HABITACIONES</a>
                <a href="ControladorAgregarReservas?accion=add" class="btn-custom reservas">AGREGAR RESERVA</a>
            </div>
